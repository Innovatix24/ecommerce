...
public class ProductWiseSaleReportDocument : IDocument
{
    private readonly OrderDto _order;
    private readonly IWebHostEnvironment _env;
    private readonly CompanyInfoDto _company;

    public ProductWiseSaleReportDocument(OrderDto order, IWebHostEnvironment env, CompanyInfoDto? company)
    {
        _order = order;
